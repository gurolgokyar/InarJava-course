package week_09_objectOrientedPrograming_1.assignments.exercise_09_12;

import week_09_objectOrientedPrograming_1.assignments.exercise_09_11.LinerEquation;
...
public class IntersectingPoint {
    ...
    public IntersectingPoint(double[] points) {
        this.x1 = points[0];
        this.y1 = points[1];
        this.x2 = points[2];
        this.y2 = points[3];
        ...
        this.x4 = points[6];
        this.y4 = points[7];
        linerEquation = new LinerEquation(this.getCoefficient());
    }
...
//    double f = c*points[2][0] - d*points[2][1];
    ...
    public String toString() {
        ...
        if ((y1 - y2) * (x3 - x4) - (x1 - x2) * (y3 - y4) != 0) {
            s =
                    "The intersecting point is at (" + (int) (linerEquation.getX() * 100000) / 100000.0 + ", " + (int) (linerEquation.getY() * 100000) / 100000.0 + ")";
        } else {
